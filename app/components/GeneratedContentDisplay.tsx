          ...
          <div className="space-y-6">
            ...
            <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-sm text-purple-700">{content.seoTitle.length}/60</span>
              </div>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-sm text-blue-700">{content.metaDescription.length}/160</span>
              </div>
            ...
            <div className="bg-orange-50 border border-orange-200 rounded-lg p-4">
              <h4 className="font-semibold text-orange-900 mb-3">Target Keywords</h4>
